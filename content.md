...
- Logo + Navigation
- Hero (big img + big text)
- Featured in
- How it works (roadmap like)
- Meals(and list of diets)
- Testimonials + Gallery (textimonial textbox + img box)
- Pricing + features (figure box)
- Call to action (subscription box)
- Footer (list)
